...
def load_and_process_data(csv_2023_file, csv_2024_file):
    data_2023 = pd.read_csv(csv_2023_file, encoding='utf-8', delimiter=';', on_bad_lines='skip', low_memory=False)
    data_2024 = pd.read_csv(csv_2024_file, encoding='utf-8', delimiter=';', on_bad_lines='skip', low_memory=False)
